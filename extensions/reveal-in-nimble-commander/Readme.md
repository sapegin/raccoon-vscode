# Reveal in Nimble Commander 📂

Reveal current project or file in [Nimble Commander](https://magnumbytes.com).

**Install from [Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=sapegin.reveal-in-nimble-commander) or [Open VSX Registry](https://open-vsx.org/extension/sapegin/reveal-in-nimble-commander)**

[![Washing your code. A book on clean code for frontend developers](https://sapegin.me/images/washing-code-github.jpg)](https://sapegin.me/book/)

## Commands

![Reveal in Nimble Commander commands](screenshots/screenshot.png)
...
| Description | Name |
| --- | --- |
| Reveal project root folder | `revealInNimbleCommander.revealProject` |
| Reveal currently open file | `revealInNimbleCommander.revealFile` |
...
Additionally, check out [my theme for Nimble Commander](https://sapegin.me/squirrelsong/nimble-commander/).
