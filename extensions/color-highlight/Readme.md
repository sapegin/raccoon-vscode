# Color Highlight Visual Studio Code extension 🦎

Visual Studio Code extension that underlines hex color values with the actual color.
...
- Underlines hex color values (`#f00`, `#FF0000`, `#f00c`, `#ff0000cc`) with the actual color.
